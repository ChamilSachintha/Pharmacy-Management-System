    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_GET['id'])) {
                ...
                if($count2==1) {
                    ...
                    // Redirect to Manage Employee with a message
        ...
        <?php
            ...
            if(isset($_POST['submit'])) {
                ...
                // 4. Redirect to Manage Employee page with a message
                // Check whether the query is executed or not
                if($res3==TRUE) {
                    // Employee updated
                    $_SESSION['update'] = "<div class='success'>Employee is updated successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-employee.php');
                } else {
