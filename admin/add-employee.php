        ...
        <form action="" method="POST">
            ...
            <table class="tbl-30">
                <tr>
                    <td>Full Name: </td>
                    <td>
                        <input type="text" name="full_name" placeholder="Enter employee's full name here">
                    </td>
                </tr>
                ...
                <tr>
                    <td>Username: </td>
                    <td>
                        <input type="text" name="username" placeholder="Enter a username for employee">
                    </td>
                </tr>
                ...
                <tr>
                    <td colspam="2">
                        <input type="submit" name="submit" value="Save Employee" class="btn-primary">
                    </td>
                </tr>
...
<?php
    ...
    if(isset($_POST['submit'])) 
    {
        ...
        if($res==TRUE) {
            ...
            echo("<script>location.href = '".SITEURL."/admin/manage-employee.php?msg=$msg';</script>");
